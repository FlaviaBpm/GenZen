  ...
  <main>
    <section class="hero" id="home">
      <header>
        ...
        <p class="h1 text-dark">
          <h1>Cultivez votre sérénité mentale</h1>
          <h3>Comme les fleurs, donnez-vous le temps de  grandir et de vous épanouir</h3>
        </p>
    ...
    <section class="container section about" id="about">
      <div class="row align-items-center">
        ...
        <div class="col-md">
          <img class="img-fluid" src="assets/img/fond-accueil.png" alt="brain flower">
        </div>
      </div>
    </section>
