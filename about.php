      ...
      <div class="row">
        <div class="col order-last">
          <div class="image-acceuil">
              <img src="#" alt="image fond d'accueil" height="370px">
          </div>
        </div>
        <div class="col order-first">
          <div class="card-accueil" style="width: 18rem;">
              <div class="card-body">
                <h2 class="card-title">Cultivez votre sérinité mental</h2>
<br>

                <h5 class="card2-title"> parce qu'être zen, c'est zénial !</h5>

<br>
                <p class="card-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
                <a href="quizz.php" class="btn btn-dark">Commencer le test</a>
              </div>
            </div>
          </div>
      </div>
